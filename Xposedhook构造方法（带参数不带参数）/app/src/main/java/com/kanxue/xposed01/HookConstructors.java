...
public class HookConstructors implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable {
        ...
        if (loadPackageParam.packageName.equals("com.example.testxp")) {
            ...
            Class student = classLoader.loadClass("com.example.testxp.student");
            ...
            XposedHelpers.findAndHookConstructor(student, String.class,String.class,int.class,new XC_MethodHook() {
                //  public Member method;
                //        public Object thisObject;
                //        public Object[] args;
                @Override
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                    ...
                    XposedBridge.log("com.example.testxp.student 1 args is called--name--id--age"+name+id+age);
                }
